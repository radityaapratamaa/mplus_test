...
class Labels {
	...
	var $labels_across		= 4; // number of labels horizontally across the page
	var $labels_down		= 7; // number of labels vertically down the page
	var $label_height		= 2; // the height, in centimeters, of each label
	var $label_width		= 3; // the width, in centimeters, of each label
	...
	var $padding_top		= 1; // the top padding, in centimeters, of each label
